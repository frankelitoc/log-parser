...
<div class="max-w-xl mx-auto" id="drop-area">
    <p class="my-4 text-center">Kaseya - IIS Log Parser</p>
    <p class="my-4 text-center">For security reasons log file is immediately deleted once uploaded and processed</p>
